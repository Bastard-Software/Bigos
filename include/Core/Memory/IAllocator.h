    ...
    namespace Core
    {
        namespace Memory
        {
            ...
            public:
                ...
                virtual RESULT Allocate( size_t size, void** ppMemory, const char* pFile = __FILE__, uint32_t line = __LINE__ ) = 0;
                virtual RESULT AllocateAligned( size_t size, size_t alignment, void** ppMemory, const char* pFile = __FILE__,
