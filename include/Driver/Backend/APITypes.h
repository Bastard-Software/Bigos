            ...
            struct BindingHeapDesc
            {
                union
                {
                    struct
                    {
                        ...
                        uint32_t storageTextureCount;          // STORAGE_TEXTURE
                        uint32_t constantTexelBufferCount;     // CONSTANT_TEXEL_BUFFER
                        uint32_t storageTexelBufferCount;      // STORAGE_TEXEL_BUFFER
                        uint32_t constantBufferCount;          // CONSTANT_BUFFER
                        uint32_t readOnlyStorageBufferCount;   // READ_ONLY_STORAGE_BUFFER
                        uint32_t readWriteStoreageBufferCount; // READ_WRITE_STORAGE_BUFFER
                    };
                    uint32_t saplerCount;
                };
