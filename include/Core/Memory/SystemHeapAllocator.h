    ...
    namespace Core
    {
        namespace Memory
        {
            ...
            public:
                ...
                BGS_FORCEINLINE RESULT Allocate( size_t size, void** ppMemory, const char* pFile = __FILE__,
                                                 uint32_t line = __LINE__ ) override;
                BGS_FORCEINLINE RESULT AllocateAligned( size_t size, size_t alignment, void** ppMemory,
